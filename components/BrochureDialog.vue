      ...
      <v-card>
        <v-card-text class="avenir font-14pt black--text pt-6">
          ...
          >
            ...
            <span class="avenir-heavy"><a href="mailto:gerenciariviera@inversionescapital.com" target="_blank" rel="noopener">
              gerenciariviera@inversionescapital.com
            </a></span>
          </v-alert>
...
export default {
  ...
  methods: {
    async sendForm () {
      ...
      this.loading = true
      try {
        await this.$axios.post('https://03od44pgi6.execute-api.us-east-1.amazonaws.com/sendBrochureEmail', this.form)
    ...
    async notify () {
      try {
        await this.$axios.post('https://jjwtgeftxj.execute-api.us-east-1.amazonaws.com/send', this.form)
      } catch (e) {}
    },
  }
}
